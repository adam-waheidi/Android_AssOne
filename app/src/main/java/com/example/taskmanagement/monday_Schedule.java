...
public class monday_Schedule extends AppCompatActivity {
    ...
    private void initializeArrayList() {    //Add initial values to the ArrayList
        ...
        lecturesArrayList.add(new Lecture("Geography","8:00 - 8:50"));
        lecturesArrayList.add(new Lecture("Chemistrey", "9:55 - 10:45"));
        lecturesArrayList.add(new Lecture("Physics", "10:50 - 11:30"));
        lecturesArrayList.add(new Lecture("Science", "11:35 - 12:20"));
    }
    //_____________________________________________________________________________________________________________________________________
